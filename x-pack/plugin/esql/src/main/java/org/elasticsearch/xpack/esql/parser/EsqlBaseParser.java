...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_functionExpression = 10, RULE_methodExpression = 11, RULE_dataType = 12, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "primaryExpression", "functionExpression", "methodExpression", "dataType", 
  ...
  @SuppressWarnings("CheckReturnValue")
  public static class MethodInvocationContext extends PrimaryExpressionContext {
    public PrimaryExpressionContext primaryExpression() {
      return getRuleContext(PrimaryExpressionContext.class,0);
    }
    ...
    @SuppressWarnings("this-escape")
    public MethodInvocationContext(PrimaryExpressionContext ctx) { copyFrom(ctx); }
    @Override
    public void enterRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).enterMethodInvocation(this);
    }
    @Override
    public void exitRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).exitMethodInvocation(this);
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof EsqlBaseParserVisitor ) return ((EsqlBaseParserVisitor<? extends T>)visitor).visitMethodInvocation(this);
      else return visitor.visitChildren(this);
    }
  }
  @SuppressWarnings("CheckReturnValue")
    ...
    try {
      ...
      while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
        if ( _alt==1 ) {
          ...
          case 2:
            {
            _localctx = new MethodInvocationContext(new PrimaryExpressionContext(_parentctx, _parentState));
            pushNewRecursionContext(_localctx, _startState, RULE_primaryExpression);
            setState(253);
            if (!(precpred(_ctx, 1))) throw new FailedPredicateException(this, "precpred(_ctx, 1)");
            setState(254);
  ...
  public static class MethodExpressionContext extends ParserRuleContext {
    ...
    @Override
    public void enterRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).enterMethodExpression(this);
    }
    @Override
    public void exitRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).exitMethodExpression(this);
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof EsqlBaseParserVisitor ) return ((EsqlBaseParserVisitor<? extends T>)visitor).visitMethodExpression(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public final MethodExpressionContext methodExpression() throws RecognitionException {
    ...
    try {
      ...
      _errHandler.sync(this);
      _la = _input.LA(1);
      if (((((_la - 30)) & ~0x3f) == 0 && ((1L << (_la - 30)) & 7447511844871L) != 0)) {
        {
        {
        setState(278);
        booleanExpression(0);
  ...
  public static final String _serializedATN =
    ...
    ",\u0203\b,\n,\f,\u0206\t,\u0001-\u0001-\u0001-\u0001-\u0001.\u0001.\u0001"+
    "/\u0001/\u0003/\u0210\b/\u00010\u00030\u0213\b0\u00010\u00010\u00011\u0003"+
    "1\u0218\b1\u00011\u00011\u00012\u00012\u00013\u00013\u00014\u00014\u0001"+
    "4\u00015\u00015\u00015\u00015\u00016\u00016\u00016\u00017\u00017\u0001"+
    "7\u00018\u00018\u00018\u00018\u00038\u0231\b8\u00018\u00018\u00018\u0001"+
    "8\u00058\u0237\b8\n8\f8\u023a\t8\u00038\u023c\b8\u00019\u00019\u00019"+
    "\u00039\u0241\b9\u00019\u00019\u0001:\u0001:\u0001:\u0001:\u0001:\u0001"+
    ":\u0000\u0004\u0002\n\u0010\u0012;\u0000\u0002\u0004\u0006\b\n\f\u000e"+
    "\u0010\u0012\u0014\u0016\u0018\u001a\u001c\u001e \"$&(*,.02468:<>@BDF"+
    "HJLNPRTVXZ\\^`bdfhjlnprt\u0000\b\u0001\u0000?@\u0001\u0000AC\u0002\u0000"+
    "\u0019\u0019\u001e\u001e\u0001\u0000GH\u0002\u0000##\'\'\u0001\u0000*"+
    "+\u0002\u0000))77\u0002\u000088:>\u0265\u0000v\u0001\u0000\u0000\u0000"+
    "\u0002y\u0001\u0000\u0000\u0000\u0004\u008a\u0001\u0000\u0000\u0000\u0006"+
    "\u009a\u0001\u0000\u0000\u0000\b\u009c\u0001\u0000\u0000\u0000\n\u00bb"+
